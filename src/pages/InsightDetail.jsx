    ...
    <>
      ...
      <section className="bg-[var(--color-surface-soft)] py-14 md:py-20">
        <div className="container">
          ...
          <Link
            to="/insights"
            className="mb-8 inline-flex items-center gap-2 text-sm font-medium text-[var(--color-text-muted)] transition-colors hover:text-[var(--color-primary)]"
          >
          ...
          <div className="mx-auto max-w-3xl">
            ...
            <h1 className="mb-5 text-3xl font-black leading-[1.1] tracking-tight text-[var(--color-text-primary)] sm:text-4xl md:text-5xl">
              {insight.title}
            </h1>
            <p className="mb-7 text-lg leading-relaxed text-[var(--color-text-secondary)]">
              {insight.excerpt}
            </p>

            {/* Meta row */}
            <div className="flex flex-wrap items-center gap-x-6 gap-y-2 border-t border-[var(--color-border)] pt-5">
