...
function DetailRow({ label, value }) {
  ...
  return (
    <div className="border-t border-white/10 py-3 first:border-t-0 first:pt-0 sm:flex sm:gap-6">
      <dt className="text-xs font-semibold uppercase tracking-widest text-white/45 sm:w-40 sm:shrink-0">
        {label}
      </dt>
      <dd className="mt-1 break-words text-base text-white sm:mt-0">{value}</dd>
    </div>
  );
}
          ...
          <div aria-live="polite" aria-busy={state === "loading"}>
            ...
            {state === "found" && presentation && (
              <div className={panel}>
                ...
                <p className="mb-8 text-base leading-relaxed text-white/68">{presentation.body}</p>

                <dl className="mb-8">
                  <DetailRow label="Awarded to" value={certificate.issuedName} />
                  ...
                  <DetailRow label="Certificate ID" value={certificate.publicId} />
                </dl>
